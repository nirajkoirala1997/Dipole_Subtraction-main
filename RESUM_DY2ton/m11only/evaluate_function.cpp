...
//a[9279] = (nn(4)*(a[4] + pow(a[14],6)*a[15] + 
//       pow(a[14],3)*pow(a[15],2)*nn(-16) + 
//       pow(a[14],2)*pow(a[15],2)*nn(-4) + 
//       pow(a[14],4)*pow(a[15],2)*nn(-4) + 
//       a[14]*pow(a[15],2)*nn(-3) + 
//       pow(a[14],5)*pow(a[15],2)*nn(-3) + 
//       pow(a[14],3)*nn(-2) + 
//       pow(a[14],3)*pow(a[15],4)*nn(-2) + 
//       pow(a[14],5)*nn(-1) + 
//       a[14]*a[15]*nn(4) + 
//       pow(a[14],5)*a[15]*nn(4) + 
//       pow(a[14],2)*pow(a[15],3)*nn(4) + 
//       pow(a[14],4)*pow(a[15],3)*nn(4) + 
//       pow(a[14],3)*a[15]*nn(8) + 
//       pow(a[14],2)*a[15]*nn(13) + 
//       pow(a[14],4)*a[15]*nn(13)))/
//   (pow(a[2],2)*a[14]*pow(a[15],2))  ;
