C----------------------------------------------------------------------
C  # alphaS(1GeV) = 0.68183
C  Grids/mstw2008lo.00.dat: # alphaS(MZ) = 0.13939
C  Grids/mstw2008lo.00.dat: # alphaSorder,alphaSnfmax = 0, 5

C  Grids/mstw2008nlo.00.dat: # alphaSorder,alphaSnfmax = 1, 5
C  Grids/mstw2008nlo.68cl.01.dat: # alphaS(1GeV) = 0.49128
C  Grids/mstw2008nlo.68cl.01.dat: # alphaS(MZ) = 0.12018

C Grids/mstw2008nnlo.68cl.08.dat: # alphaSorder,alphaSnfmax = 2, 5
C Grids/mstw2008nnlo.68cl.09.dat: # alphaS(1GeV) = 0.45077
C Grids/mstw2008nnlo.68cl.09.dat: # alphaS(MZ) = 0.11707
