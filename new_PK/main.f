...
c          print*," "
c      write(*,*) achar(27)//'[1;32m' // "For xq = ",int(xq) ,achar(27) 
c     .   //'[0m'
c          print*," "

          call brm48i(40,0,0) ! initialize random number generator
          call vsup_2(4,npt1,its1,flo2_Plus,ai_lo2,sd,chi2)
...
c            print*,"  "
c            print*,"  "
c            write(*,*)achar(27)//'[1;32m'//"Integral [P+K]=", 
c     .      ai_lo2,achar(27) //'[0m', "+-",err(j)
...
c       write(*,*)achar(27)//'[1;32m'//"   xq"," ","   Integral PK ",
c     .  "                    error",
c     . achar(27)//'[0m'
        do j=1,it_max
