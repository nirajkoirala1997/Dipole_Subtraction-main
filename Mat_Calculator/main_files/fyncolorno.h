...
id Vx(x1?,x2?,gluglugluglu,`i',`j',`k',`l',p1?,p2?,p3?,p4?) =
 -gs^2*((d_(li`j',li`k')*d_(li`i',li`l')-d_(li`j',li`l')*d_(li`k',li`i'))
      + (d_(li`i',li`j')*d_(li`k',li`l')-d_(li`i',li`l')*d_(li`j',li`k'))                
      + (d_(li`i',li`k')*d_(li`j',li`l')-d_(li`k',li`i')*d_(li`l',li`j')));

id Vx(x1?,x2?,gluglugluglu,-`i',-`j',-`k',-`l', p1?, p2?, p3?, p4?) = 
 -gs^2*((d_(lix`j',lix`k')*d_(lix`i',lix`l')-d_(lix`j',lix`l')*d_(lix`k',lix`i'))
      + (d_(lix`i',lix`j')*d_(lix`k',lix`l')-d_(lix`i',lix`l')*d_(lix`j',lix`k'))
      + (d_(lix`i',lix`k')*d_(lix`j',lix`l')-d_(lix`k',lix`i')*d_(lix`l',lix`j')));
...
*#do l = 1,10
*id Vx(x1?,x2?,gluglugluglu,`i',`j',`k',`l',p1?,p2?,p3?,p4?) = 
*                     -i_*gs^2*((d_(li`i',li`j')*d_(li`k',li`l')-d_(li`i',li`l')*d_(li`k',li`j')) 
*               	      + (d_(li`i',li`k')*d_(li`j',li`l')-d_(li`i',li`j')*d_(li`k',li`l'))
*                             + (d_(li`i',li`l')*d_(li`j',li`k')-d_(li`i',li`j')*d_(li`l',li`k'))) ;
*
*id Vx(x1?,x2?,gluglugluglu,-`i',-`j',-`k',-`l',p1?,p2?,p3?,p4?) = 
