...
id epolglu(lix1?,p1,0)*epolglu(lix101?,p1,0) = - d_(lix1,lix101)+(p1(lix1)*n1(lix101)+n1(lix101)*p1(lix1))/p1.n1;
id epolglu(lix1?,p2,0)*epolglu(lix101?,p2,0) = - d_(lix1,lix101)+(p2(lix1)*n2(lix101)+n2(lix101)*p2(lix1))/p2.n2;
id epolglu(lix1?,p5,0)*epolglu(lix101?,p5,0) = - d_(lix1,lix101)+(p5(lix1)*n3(lix101)+n3(lix101)*p5(lix1))/p5.n3;
.sort
