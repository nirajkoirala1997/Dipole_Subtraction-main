...
id in(upq(-`i',p1?)) =  U(six`i',p1,mu);
id in(UPQ(-`i',p1?)) = VB(six`i',p1,mu);
...
id ou(upq(-`i',p1?)) = UB(six`i',p1,mu);
id ou(UPQ(-`i',p1?)) = V(six`i',p1,mu);
...
id Vx(x1?,x2?,UPQupqglu, `i', `j', `k',p1?,p2?,p3?) = (i_)*gs*G( si`i', si`j', li`k');
id Vx(x1?,x2?,UPQupqglu, `i', `j',-`k',p1?,p2?,p3?) = (i_)*gs*G( si`i', si`j',lix`k');
id Vx(x1?,x2?,UPQupqglu, `i',-`j', `k',p1?,p2?,p3?) = (i_)*gs*G( si`i',six`j', li`k');
id Vx(x1?,x2?,UPQupqglu, `i',-`j',-`k',p1?,p2?,p3?) = (i_)*gs*G( si`i',six`j',lix`k');
id Vx(x1?,x2?,UPQupqglu,-`i', `j', `k',p1?,p2?,p3?) = (i_)*gs*G(six`i', si`j', li`k');
id Vx(x1?,x2?,UPQupqglu,-`i', `j',-`k',p1?,p2?,p3?) = (i_)*gs*G(six`i', si`j',lix`k');
id Vx(x1?,x2?,UPQupqglu,-`i',-`j', `k',p1?,p2?,p3?) = (i_)*gs*G(six`i',six`j', li`k');
id Vx(x1?,x2?,UPQupqglu,-`i',-`j',-`k',p1?,p2?,p3?) = (i_)*gs*G(six`i',six`j',lix`k');
...
id QQ(`i',`j',p1?,x3?)=i_*(G(si`i',si`j',p1)+x3*G(si`i',si`j'))*fprop(p1);
