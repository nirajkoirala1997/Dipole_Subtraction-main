...
id in(glu(-`i',p1?)) = epolglu(lix`i',p1,0);
...
id ou(glu(-`i',p1?)) = epolglu(lix`i',p1,0);
...
id Vx(x1?,x2?,glugluglu,`i',`j',`k',p1?,p2?,p3?) = gs*(d_(li`i',li`j')*(p1(li`k')-p2(li`k'))+
							                    d_(li`j',li`k')*(p2(li`i')-p3(li`i'))+
							                    d_(li`k',li`i')*(p3(li`j')-p1(li`j'))); 

id Vx(x1?,x2?,glugluglu,`i',`j',-`k',p1?,p2?,p3?) = gs*(d_(li`i',li`j')*(p1(lix`k')-p2(lix`k'))+
								              d_(li`j',lix`k')*(p2(li`i')-p3(li`i'))+
									      d_(lix`k',li`i')*(p3(li`j')-p1(li`j'))); 

id Vx(x1?,x2?,glugluglu,`i',-`j',`k',p1?,p2?,p3?) = gs*(d_(li`i',lix`j')*(p1(li`k')-p2(li`k'))+
									      d_(lix`j',li`k')*(p2(li`i')-p3(li`i'))+
								      	      d_(li`k',li`i')*(p3(lix`j')-p1(lix`j'))); 

id Vx(x1?,x2?,glugluglu,`i',-`j',-`k',p1?,p2?,p3?) = gs*(d_(li`i',lix`j')*(p1(lix`k')-p2(lix`k'))+
									        d_(lix`j',lix`k')*(p2(li`i')-p3(li`i'))+
									        d_(lix`k',li`i')*(p3(lix`j')-p1(lix`j'))); 

id Vx(x1?,x2?,glugluglu,-`i',`j',`k',p1?,p2?,p3?) = gs*(d_(lix`i',li`j')*(p1(li`k')-p2(li`k'))+
									      d_(li`j',li`k')*(p2(lix`i')-p3(lix`i'))+
									      d_(li`k',lix`i')*(p3(li`j')-p1(li`j'))); 

id Vx(x1?,x2?,glugluglu,-`i',`j',-`k',p1?,p2?,p3?) = gs*(d_(lix`i',li`j')*(p1(lix`k')-p2(lix`k'))+
									        d_(li`j',lix`k')*(p2(lix`i')-p3(lix`i'))+
									        d_(lix`k',lix`i')*(p3(li`j')-p1(li`j'))); 

id Vx(x1?,x2?,glugluglu,-`i',-`j',`k',p1?,p2?,p3?) = gs*(d_(lix`i',lix`j')*( p1(li`k') - p2(li`k'))+
									        d_(lix`j',li`k')*( p2(lix`i') - p3(lix`i'))+
 									        d_(li`k',lix`i')*( p3(lix`j') - p1(lix`j'))); 

id Vx(x1?,x2?,glugluglu,-`i',-`j',-`k',p1?,p2?,p3?) = gs*(d_(lix`i',lix`j')*(p1(lix`k')-p2(lix`k'))+
...
id Vx(x1?,x2?,glugluHig,`i',`j',x3?,p1?,p2?,p3?) =   -i_*ch*(-d_(li`i',li`j')*p1.p2 + p1(li`i')*p2(li`j'));
id Vx(x1?,x2?,glugluHig,`i',-`j',x3?,p1?,p2?,p3?) =  -i_*ch*(-d_(li`i',lix`j')*p1.p2 + p1(li`i')*p2(lix`j'));
id Vx(x1?,x2?,glugluHig,-`i',`j',x3?,p1?,p2?,p3?) =  -i_*ch*(-d_(lix`i',li`j')*p1.p2 + p1(lix`i')*p2(li`j'));
id Vx(x1?,x2?,glugluHig,-`i',-`j',x3?,p1?,p2?,p3?) = -i_*ch*(-d_(lix`i',lix`j')*p1.p2 + p1(lix`i')*p2(lix`j'));
...
id Vx(x1?,x2?,gluglugluHig,`i',`j',`k',x3?,p1?,p2?,p3?,p4?) = -gs*ch*( (p3(li`i')-p2(li`i'))*d_(li`j',li`k')
										  + (p1(li`j')-p3(li`j'))*d_(li`i',li`k')
                                                                              	  + (p2(li`k')-p1(li`k'))*d_(li`i',li`j'));

id Vx(x1?,x2?,gluglugluHig,`i',`j',-`k',x3?,p1?,p2?,p3?,p4?) = -gs*ch*( (p3(li`i')-p2(li`i'))*d_(li`j',lix`k')
										  + (p1(li`j')-p3(li`j'))*d_(li`i',lix`k')
                                                                              	  + (p2(lix`k')-p1(lix`k'))*d_(li`i',li`j'));

id Vx(x1?,x2?,gluglugluHig,`i',-`j',`k',x3?,p1?,p2?,p3?,p4?) = -gs*ch*( (p3(li`i')-p2(li`i'))*d_(lix`j',li`k')
										  + (p1(lix`j')-p3(lix`j'))*d_(li`i',li`k')
										  + (p2(li`k')-p1(li`k'))*d_(li`i',lix`j'));

id Vx(x1?,x2?,gluglugluHig,`i',-`j',-`k',x3?,p1?,p2?,p3?,p4?) = -gs*ch*( (p3(li`i')-p2(li`i'))*d_(lix`j',lix`k')
										  + (p1(lix`j')-p3(lix`j'))*d_(li`i',lix`k')
                                                                              	  + (p2(lix`k')-p1(lix`k'))*d_(li`i',lix`j'));

id Vx(x1?,x2?,gluglugluHig,-`i',`j',`k',x3?,p1?,p2?,p3?,p4?) = -gs*ch*( (p3(lix`i')-p2(lix`i'))*d_(li`j',li`k')
										  + (p1(li`j')-p3(li`j'))*d_(lix`i',li`k')
                                                                              	  + (p2(li`k')-p1(li`k'))*d_(lix`i',li`j'));

id Vx(x1?,x2?,gluglugluHig,-`i',`j',-`k',x3?,p1?,p2?,p3?,p4?) = -gs*ch*( (p3(lix`i')-p2(lix`i'))*d_(li`j',lix`k')
										  + (p1(li`j')-p3(li`j'))*d_(lix`i',lix`k')
                                                                             	  + (p2(lix`k')-p1(lix`k'))*d_(lix`i',li`j'));

id Vx(x1?,x2?,gluglugluHig,-`i',-`j',`k',x3?,p1?,p2?,p3?,p4?) = -gs*ch*( (p3(lix`i')-p2(lix`i'))*d_(lix`j',li`k')
										  + (p1(lix`j')-p3(lix`j'))*d_(lix`i',li`k')
                                                                              	  + (p2(li`k')-p1(li`k'))*d_(lix`i',lix`j'));

id Vx(x1?,x2?,gluglugluHig,-`i',-`j',-`k',x3?,p1?,p2?,p3?,p4?) = -gs*ch*( (p3(lix`i')-p2(lix`i'))*d_(lix`j',lix`k')
...
id GG(`i',`j',p1?,x1?)=-i_*d_(li`i',li`j')*gprop(p1);
