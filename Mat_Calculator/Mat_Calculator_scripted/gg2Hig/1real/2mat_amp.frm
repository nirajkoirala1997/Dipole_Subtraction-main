...
id epolglu(lix1?,p1,0)*epolglu(lix101?,p1,0) = - d_(lix1,lix101)+(p1(lix1)*p2(lix101)+p1(lix101)*p2(lix1))/p1.p2;
id epolglu(lix1?,p2,0)*epolglu(lix101?,p2,0) = - d_(lix1,lix101)+(p2(lix1)*p1(lix101)+p2(lix101)*p1(lix1))/p2.p1;
