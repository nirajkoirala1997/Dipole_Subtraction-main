...
cc     [u U -> e E]  Born 
cc--------------------------------------------------------------------o
c       function Born_uU2eE(k,p1,p2,p3,p4)
c       implicit double precision (a-h,o-z)
...
c      IF(k .eq. 0)  CF =  1d0                   !Leading Order K=0
c      IF(k .eq. 1)  CF = -4d0/3d0               !leg 1
c      IF(k .eq. 2)  CF = -4d0/3d0               !Leg 2
c      s13 =  2.0d0*dot(p1,p3) ! t
c      s23 =  2.0d0*dot(p1,p4) ! u
c      s12 =  2.0d0*dot(p1,p2) ! s
c      XNC = 1/4d0
c      xnorm =1d0
c      qu2 = 4d0/9d0
c
