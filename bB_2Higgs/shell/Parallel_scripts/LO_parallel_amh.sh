...
tmp_dir=$(mktemp -d)
tmp_dir2=$(mktemp -d)
cp run.machine.dat output_files.dat param_card.dat $tmp_dir
cp run.machine.dat output_files.dat param_card.dat $tmp_dir2
...
cp $tmp_dir2/run.machine.dat $tmp_dir2/output_files.dat $tmp_dir2/param_card.dat .
rm -rf $tmp_dir
rm -rf $tmp_dir2
