...
C--------
      ...
      If(mid.eq.1)Then          ! LHC
c      f(7)=(fa(1)+16.0d0*fa(2)+fa(3)+16.0d0*fa(4)+fa(5))/81.0d0*fb(0)
c     .+(fa(-1)+16.0d0*fa(-2)+fa(-3)+16.0d0*fa(-4)+fa(-5))/81.0d0*fb(0)
       f(7) = 4.0d0*fa( 2)/9.0d0*fb(0)
     .    +   4.0d0*fa(-2)/9.0d0*fb(0)
      ELSEIF(mid.eq.0)Then      ! TEVATRON
...
c      f(8)=(fb(1)+16.0d0*fb(2)+fb(3)+16.0d0*fb(4)+fb(5))/81.0d0*fa(0)
c     .+(fb(-1)+16.0d0*fb(-2)+fb(-3)+16.0d0*fb(-4)+fb(-5))/81.0d0*fa(0)
        f(8) = fb( 2)*4.0d0/9.0d0*fa(0)
     .       + fb(-2)*4.0d0/9.0d0*fa(0)
